...
const EcoDashboard = ({ userRole, userName, onNavigateToLessons, onNavigateToChallenges }: EcoDashboardProps) => {
  ...
  const stats = [
    { title: 'Challenges Done', value: 12, icon: Target, color: 'from-emerald-500 to-green-500' },
    { title: 'Lessons Learned', value: 8, icon: BookOpen, color: 'from-blue-500 to-cyan-500' },
    { title: 'Badges Earned', value: 5, icon: Award, color: 'from-yellow-500 to-orange-500' },
  ];
    ...
    return (
      <div className="relative flex items-center justify-center">
        <svg width="280" height="280" className="transform -rotate-90">
          <circle cx="140" cy="140" r={radius} stroke="rgb(209 213 219)" strokeWidth={strokeWidth} fill="none" className="opacity-20" />
          <motion.circle
            cx="140"
            cy="140"
            r={radius}
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {stats.map((stat) => {
                ...
                return (
                  <Card key={stat.title} className="bg-white/80 backdrop-blur-sm border-emerald-200 shadow-lg text-center p-4">
